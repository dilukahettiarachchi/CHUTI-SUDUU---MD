/**
    *CHUUTI SUDUU MD WA BOT Created By DILLA EDITZ
*/
require('./config')
...
module.exports = conn = async (conn, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [botNumber, ...global.owner, '94764570094@s.whatsapp.net'].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
    ...
    */
        ...
        if (db.data.settings[botNumber].autobio) {
            ...
            if (new Date() * 1 - setting.status > 1000) {
                ...
                await conn.updateProfileStatus(`I am ${namabot} | Active During ${uptime} ⏳ | Mode : ${conn.public ? 'Public-Mode 👥' : 'Self-Mode 👤'} | User : ${Object.keys(global.db.data.users).length} 👥| Don't call bots📞 | © Created BY DILLA EDITZ`).catch(_ => _)
...
「 INFO USER 」
 ...
 ❐ Status : ${isCreator ? "Owner 👑️" : "DILLA EDITZ ⚔️"}
...
┌┤「SNK 」
│└─────────────┈❖
│1. Your Whatsapp data will be ours
│ Save On Our Server
│ As long as BOT is Active.
│2. Your data will be deleted
│ When BOT is OFF.
│3. We Don't Store Images/
│ Videos/Files/Audio/Documents
│ What You Send.
│4. We Never Ask
│ You To Give
│ Personal Information.
│5. If you find a BUG/ERROR
│ Please REPORT!.
└┬─────────────┈❖
┌┤「ATTENTION 」
│└─────────────┈❖
│1. Bot Will Block Your Number.
│2. You Can't.
│ Accessing the Bot Again.
│3. Exploits Against bots.
...
│• FUND : ${global.dana}
│
│• Q.S Az-Zalzalah Verse 7 :
│
│So whoever does an atom's weight of good will see it.
│
│• Meaning: So whoever
│do a weight of goodness,
│undoubtedly he will see
│(reply).
│
│ *Thank You*
└──────────────┈❖`
